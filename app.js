...
function detail() {
  ...
  const dates = ["Mon, 15 Apr 2024", "Tue, 16 Apr 2024", "Wed, 17 Apr 2024", "Mon, 22 Apr 2024"];
  const times = ["11:30", "13:30", "16:30", "20:30"];
  return layout(`
    <div class="detail-layout">
      <section class="detail-panel">
        ...
        <div class="field-group">
          ...
          <div class="chip-row">
            ${dates.map((date) => `<button class="chip ${state.selectedDate === date ? "active" : ""}" data-date="${date}">${date.split(", ")[0]}<br>${date.split(", ")[1]}</button>`).join("")}
          </div>
        </div>
        <div class="field-group">
          <label>Time</label>
        ...
        <button class="btn" data-route="seats">Book Now</button>
      </section>
      <aside class="summary-card">
        ...
        <button class="btn" data-route="seats">Select Seat</button>
      </aside>
    </div>
  `);
}
  ...
  return layout(`
    <section class="booking-card">
      ...
      <div class="booking-lines">
        ...
        <p>Date & Time: <strong>${state.selectedDate} - ${state.selectedTime}</strong></p>
